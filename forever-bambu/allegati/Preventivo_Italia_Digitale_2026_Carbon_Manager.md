...
Codice fiscale/P.IVA: 11914080962  
Iscritta all'Elenco pubblico dei Fornitori di servizi e tecnologie 4.0 di Unioncamere Lombardia

**Spett.le**  
**FOREVER BAMBU S.P.A. SOCIETÀ BENEFIT**  
CF/P.IVA 12072470961 — REA MI-2638528  
SS 11 Padana Superiore 16/18  
20063 Cernusco sul Naviglio (MI)  
PEC: foreverbambu29@pec.it

**PREVENTIVO N. 2026/09-01**  
**Data:** 24 settembre 2026  
**Oggetto:** sviluppo del progetto “Carbon Manager Learning Operations 4.0”

In riferimento alle Vostre richieste, sottoponiamo la nostra offerta per l'analisi, l'ingegnerizzazione, l'integrazione, la sperimentazione e la messa a regime dell'evoluzione digitale e AI della piattaforma formativa Carbon Manager.

## 1. Quadro economico per work package

| Codice | Attività | Deliverable principali | Profilo / quantità | Importo netto |
|---|---|---|---|---:|
...
| Componente | Durata/quantità | Funzione nel progetto | Importo netto |
|---|---:|---|---:|
| Infrastruttura Hetzner cloud/dedicated | 12 mesi | Hosting integrazioni verticali/orizzontali, servizi applicativi e ambienti di test/produzione. | €2.400,00 |
| Database, backup, storage e monitoraggio | 12 mesi | Conservazione controllata dei dati di progetto, continuità operativa, log e monitoraggio. | €1.800,00 |
| **Totale** |  |  | **€4.200,00** |

> I servizi di assessment, integrazione, automazione e analytics sono attribuiti alla voce d) Ingegnerizzazione, quindi non ricompresi nella voce c).

> I prodotti e i piani effettivi saranno indicati nel preventivo definitivo e dovranno essere strettamente necessari al progetto. Non saranno rendicontati canoni o servizi estranei al periodo e al perimetro agevolato.

## 3. Ripartizione secondo le categorie di spesa B.3

| Voce B.3 | Componenti del preventivo | Imponibile | Incidenza |
|---|---|---:|---:|
...
## 4. Deliverable e criteri di accettazione

| WP | Deliverable | Criterio di accettazione |
|---|---|---|
| WP1 | D1 Mappa processi; D2 baseline KPI; D3 requisiti e piano test | Approvazione formale di Forever Bambu; KPI con fonte, responsabile e frequenza. |
| WP2 | D4 architettura; D5 data dictionary; D6 integrazioni prioritarie | Flussi LMS-survey-CRM verificati su casi test; ruoli e log documentati. |
| WP3 | D7 workflow; D8 moduli AI; D9 protocollo human-in-the-loop | Output AI tracciati e confrontati con revisione umana; fallback operativo disponibile. |
| WP4 | D10 dashboard; D11 manuale KPI | KPI concordati consultabili ed esportabili; dati campione riconciliati. |
| WP5 | D12 report pilota; D13 backlog; D14 verbale collaudo | Pilota completato con [N.] utenti/staff; criticità classificate e test chiusi. |
| WP6 | D15 manuali; D16 formazione; D17 procedure di messa a regime | Sessioni completate, materiali consegnati e verbale di accettazione finale. |

## 5. Inquadramento del fornitore e dell'infrastruttura

Italia Digitale S.r.l. è iscritta all'**Elenco pubblico dei Fornitori di servizi e tecnologie 4.0 di Unioncamere Lombardia**, categoria qualificata ai sensi del punto B.4 del Bando SI4.0 2026. Prima dell'invio saranno archiviate la PEC di conferma dell'iscrizione, la data antecedente alla domanda e la dichiarazione di assenza di rapporti vietati con Forever Bambu.

Le componenti cloud saranno ospitate su infrastruttura Hetzner. Hetzner dichiara, per i propri data center in Germania e Finlandia, elettricità proveniente al 100% da fonti rinnovabili, PUE medio circa 1,13, raffreddamento ad aria, WUE 0 L/kWh e sedi tedesche EMAS. Hetzner dichiara anche di non essere ancora completamente climate neutral: l'infrastruttura non viene quindi descritta come a impatto zero o carbon neutral.

## 6. Termini e condizioni

- **Validità dell'offerta:** 30 giorni dalla data di emissione.
- **Durata:** massimo 12 mesi dalla concessione del contributo, senza proroghe.
- **Avvio delle spese:** esclusivamente nel periodo ammesso dal bando e dopo le verifiche amministrative necessarie.
...
**Italia Digitale S.r.l.**  
Patrizia Gasparini — CEO

---

> **CONTROLLO PRE-FIRMA:** il preventivo è riconciliato con domanda, timeline e bozza di Allegato B per €60.000,00. Restano da confermare licenze/piani definitivi, data center Hetzner, trattamento IVA e assenza di costi non ammissibili.
